        ...
        <Header/>
            ...
            >
                <form onSubmit ={handleSubmit}>
			        ...
			        <input type="number"name = "Phone" placeholder="Telefono" value  = {form.phone}  onChange={handleChange}/>
                    <input type="text"name = "Post" placeholder="Cargo" value  = {form.post} onChange={handleChange}/>
